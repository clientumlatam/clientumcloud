              ...
              >
                ...
                <div className="pt-4 mt-4 border-t border-slate-100 dark:border-slate-700/60 flex items-center justify-between gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg bg-[var(--clientum-action,#0056B3)] hover:bg-[#004494] text-white text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer shadow-xs"
                  >
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
                  ...
                  <button
                    onClick={() => handleNavigateToModule(doc.activeTabTarget, doc.title)}
                    className="px-3 py-1.5 rounded-lg bg-[var(--clientum-action,#0056B3)] hover:bg-[#004494] text-white text-xs font-bold flex items-center gap-1.5 transition-colors cursor-pointer shadow-xs"
                  >
                    <span>Abrir Vista</span>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl w-full max-w-3xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
            ...
            <div className="p-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between shrink-0 bg-slate-50/90 dark:bg-slate-900/90">
              ...
              <button
                ...
                className="px-4 py-2 bg-[var(--clientum-action,#0056B3)] hover:bg-[#004494] text-white rounded-lg text-xs font-bold flex items-center gap-2 cursor-pointer shadow-sm transition-all"
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-xs">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl w-full max-w-3xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
            ...
            <div className="p-5 overflow-y-auto space-y-3 flex-1 text-xs">
              <pre className="p-4 rounded-xl bg-slate-900 dark:bg-slate-950 border border-slate-800 font-mono text-[11px] text-slate-200 dark:text-slate-300 leading-relaxed overflow-x-auto whitespace-pre-wrap">
                {DASHBOARD_DOCS_README_MARKDOWN}
              </pre>
            </div>
