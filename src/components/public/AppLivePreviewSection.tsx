...
export const AppLivePreviewSection: React.FC<AppLivePreviewSectionProps> = ({ onNavigate }) => {
  ...
  return (
    <section className="space-y-8 font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <div className="rounded-3xl border border-slate-800 bg-slate-950 text-white shadow-2xl overflow-hidden">
        {/* App Topbar */}
        <div className="bg-slate-900 px-4 py-3 border-b border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-bold text-slate-300 ml-2">ClientumOS — Tablero de Oportunidades & Pipeline</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[460px]">
          ...
          <div className="hidden lg:block lg:col-span-2 bg-slate-900/60 border-r border-slate-800/80 p-3 space-y-4 text-xs">
            <div className="space-y-1">
              <div className="text-[10px] font-bold text-slate-300 uppercase tracking-wider px-2">Comercial & CRM</div>
              ...
              <div className="p-2 rounded-lg text-slate-400 hover:text-white flex items-center gap-2">
                <span>Empresas</span>
              </div>
              <div className="p-2 rounded-lg text-slate-400 hover:text-white flex items-center gap-2">
                <span>Personas</span>
            ...
            <div className="space-y-1 pt-2 border-t border-slate-800/80">
              <div className="text-[10px] font-bold text-slate-300 uppercase tracking-wider px-2">WhatsApp & IA</div>
              <div className="p-2 rounded-lg text-slate-400 hover:text-white flex items-center justify-between">
                <span>WhatsApp CRM</span>
                <span className="text-[9px] bg-emerald-500/20 text-emerald-300 px-1.5 py-0.5 rounded">PRO</span>
              </div>
              <div className="p-2 rounded-lg text-slate-400 hover:text-white">Chatbot 24/7</div>
              <div className="p-2 rounded-lg text-slate-400 hover:text-white">Agente Outreach</div>
            </div>

            <div className="space-y-1 pt-2 border-t border-slate-800/80">
              <div className="text-[10px] font-bold text-slate-300 uppercase tracking-wider px-2">ERP & AFIP</div>
              <div className="p-2 rounded-lg text-slate-400 hover:text-white">Facturación AFIP</div>
              <div className="p-2 rounded-lg text-slate-400 hover:text-white">MercadoPago</div>
            </div>
          </div>
          ...
          <div className="col-span-1 lg:col-span-7 p-4 sm:p-5 space-y-4 overflow-x-auto">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-extrabold text-sm text-white">Pipeline de Ventas B2B</h4>
                <p className="text-[11px] text-slate-400">18 negocios activos · Conversión ponderada en tiempo real</p>
              </div>
              <div className="flex items-center gap-2">
                ...
                <div key={idx} className="bg-slate-900/80 border border-slate-800 rounded-2xl p-2.5 space-y-2 flex flex-col justify-between">
                  <div className="space-y-1">
                    <div className="flex items-center justify-between text-[11px] font-bold">
                      <span className="text-slate-200">{stg.name}</span>
                      <span className="text-slate-300 text-[10px] bg-slate-800 px-1.5 rounded">{stg.count}</span>
                    </div>
                  ...
                  <div className="space-y-1.5">
                    {stg.deals.map((deal, didx) => (
                      <div key={didx} className="p-2 rounded-xl bg-slate-800/90 border border-slate-700/70 space-y-1 text-left">
                        <div className="text-[11px] font-bold text-white leading-tight truncate">{deal.title}</div>
                        <div className="flex items-center justify-between text-[10px]">
                          <span className="font-extrabold text-emerald-400">{deal.value}</span>
                          <span className="px-1.5 py-0.2 rounded bg-slate-700 text-slate-300 text-[9px]">{deal.tag}</span>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2 border-t border-slate-800 text-xs">
              <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-800">
                <div className="text-[10px] text-slate-300">Ingresos Totales</div>
                <div className="text-sm font-extrabold text-white">$124.800 <span className="text-[10px] text-emerald-400">(+18.6%)</span></div>
              </div>
              <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-800">
                <div className="text-[10px] text-slate-300">Negocios Activos</div>
                <div className="text-sm font-extrabold text-white">22 <span className="text-[10px] text-emerald-400">(+15.8%)</span></div>
              </div>
              <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-800">
                <div className="text-[10px] text-slate-300">Tasa de Cierre</div>
                <div className="text-sm font-extrabold text-white">32.4% <span className="text-[10px] text-emerald-400">(+6.2%)</span></div>
              </div>
              <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-800">
                <div className="text-[10px] text-slate-300">Ticket Promedio</div>
                <div className="text-sm font-extrabold text-white">$6.218 <span className="text-[10px] text-emerald-400">(+9.3%)</span></div>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-1 lg:col-span-3 bg-slate-900/80 border-t lg:border-t-0 lg:border-l border-slate-800 p-4 flex flex-col justify-between space-y-3">
            <div className="space-y-3">
              <div className="flex items-center justify-between border-b border-slate-800 pb-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-xs font-bold text-white">Asistente IA Copilot</div>
            ...
            <form onSubmit={handleSendCopilot} className="pt-2 border-t border-slate-800 flex gap-2">
              <input
                ...
                className="w-full px-3 py-2 rounded-xl bg-slate-800 border border-slate-700 text-xs text-white placeholder-slate-500 focus:outline-hidden focus:border-cyan-400"
              />
              <button
                type="submit"
