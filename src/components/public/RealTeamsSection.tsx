        ...
        <div className="relative z-10 space-y-4 text-center max-w-2xl mx-auto">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-3">
            ...
            <button
              ...
              className="px-6 py-3.5 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 text-white font-semibold text-xs cursor-pointer transition-all flex items-center gap-1.5"
            >
