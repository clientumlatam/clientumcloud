...
export const PublicTopHeader: React.FC<PublicTopHeaderProps> = ({
  ...
  return (
    <div
      ...
      className="bg-[#0F172A] text-slate-300 border-b border-slate-800 text-[11px] font-['Plus_Jakarta_Sans',sans-serif] z-50 relative select-none"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-9 flex items-center justify-between gap-4">
        ...
        <div className="hidden lg:flex items-center gap-2 overflow-hidden text-center truncate">
          ...
          <button
            ...
            className="text-slate-200 hover:text-white font-medium hover:underline transition-all truncate flex items-center gap-1 cursor-pointer"
          >
        ...
        <div className="flex items-center gap-3 shrink-0 ml-auto lg:ml-0">
          <button
            onClick={onOpenAudit}
            className="hidden sm:flex items-center gap-1 text-slate-300 hover:text-amber-300 transition-colors cursor-pointer font-semibold"
          >
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-1 text-slate-300 hover:text-blue-300 transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-0.5 rounded bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-200 hover:text-white font-bold text-[10px] transition-colors cursor-pointer"
