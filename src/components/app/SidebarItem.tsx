        ...
        <button
          ...
          className={`flex flex-1 items-center gap-2.5 rounded-lg px-2.5 py-2 text-xs font-semibold transition-colors focus:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-500 ${
            isActive
              ...
              : 'text-[var(--text-secondary)] hover:bg-[var(--bg-muted)] dark:text-slate-200 dark:hover:bg-[#0e1626] dark:hover:text-white'
          }`}
        >
          <IconComponent
            className={`h-4 w-4 shrink-0 ${
              isActive
                ? 'text-white'
                : 'text-[var(--text-muted)] group-hover:text-[var(--text-primary)] dark:text-slate-400 dark:group-hover:text-white'
            }`}
          />
            ...
            <span
              className={`ml-auto rounded px-1.5 py-0.2 text-[10px] font-bold ${
                ...
                (isActive
                  ...
                  : 'bg-[var(--bg-muted)] text-[var(--text-secondary)] dark:bg-[#111a2d] dark:text-slate-200')
              }`}
            >
              {item.badge}
            </span>
          ...
          <button
            ...
            className={`flex h-8 w-6 items-center justify-center rounded-r-lg transition-colors ${
              isActive
                ...
                : 'text-slate-400 hover:text-[var(--text-secondary)] dark:hover:text-slate-200'
            }`}
          >
            <ChevronRight
              ...
              <button
                ...
                className={`flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-xs font-medium transition-colors focus:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-500 ${
                  subActive
                    ...
                    : 'text-[var(--text-secondary)] hover:bg-[var(--bg-muted)] dark:text-slate-300 dark:hover:bg-[#0e1626] dark:hover:text-white'
                }`}
              >
