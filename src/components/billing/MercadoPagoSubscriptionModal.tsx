      ...
      <div className="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden my-6">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white relative">
          ...
          <div className="flex items-center gap-2 mb-2">
            <span className="px-3 py-0.5 rounded-full text-[11px] font-bold bg-white/20 text-white flex items-center gap-1.5 border border-white/20">
        ...
        {checkoutSuccess ? (
          ...
          <div className="p-8 text-center space-y-6">
            ...
            <div className="space-y-2 max-w-md mx-auto">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Tu plan <strong className="text-slate-900">{checkoutSuccess.plan}</strong> ha sido activado correctamente mediante débito automático con <strong className="text-blue-600">Mercado Pago</strong>.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 text-left text-xs space-y-2 max-w-md mx-auto">
              <div className="flex justify-between text-slate-500">
                ...
                <span className="font-mono font-bold text-slate-800">{checkoutSuccess.subscriptionId}</span>
              </div>
              <div className="flex justify-between text-slate-500">
                <span>Total Facturado:</span>
                <span className="font-bold text-slate-800">${checkoutSuccess.amount.toLocaleString('es-AR')} ARS</span>
              </div>
              <div className="flex justify-between text-slate-500">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
              ...
              {checkoutSuccess.externalUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-full sm:w-auto px-4 py-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-xs flex items-center justify-center gap-1.5 transition-all"
                >
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <span className="text-xs font-bold text-slate-700">Frecuencia de Facturación:</span>
              <div className="p-1 rounded-xl bg-slate-100 flex items-center gap-1 text-xs font-semibold">
                <button
                  type="button"
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg transition-all cursor-pointer flex items-center gap-1.5 ${
                    billingCycle === 'annual' ? 'bg-blue-600 text-white shadow-xs' : 'text-slate-500'
                  }`}
                >
                  <span>Anual</span>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="text-[11px] text-slate-500">{plan.users}</div>
                      <div className="pt-2 text-lg font-black text-slate-900">
                        ${priceToShow.toLocaleString('es-AR')}
                        <span className="text-[10px] font-normal text-slate-500"> /mes</span>
                      </div>
                    </div>

                    <div className="mt-3 pt-2 border-t border-slate-100 flex items-center gap-1 text-[11px] font-semibold text-blue-700">
                      {isSelected ? (
                        <>
            ...
            <div className="space-y-3 pt-2 border-t border-slate-100">
                ...
                <div className="flex items-center gap-2 text-xs">
                  <button
                    ...
                    className={`px-2 py-0.5 rounded text-[11px] font-bold cursor-pointer transition-colors ${
                      invoiceType === 'A' ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-600'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-2 py-0.5 rounded text-[11px] font-bold cursor-pointer transition-colors ${
                      invoiceType === 'B' ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-600'
                    }`}
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <div className="px-3 py-2 rounded-xl bg-slate-100 border border-slate-200 text-xs font-bold text-slate-900 flex justify-between items-center">
            ...
            <div className="pt-4 border-t border-slate-100 space-y-3">
              <div className="flex flex-col sm:flex-row items-center gap-3">
                <button
                  type="button"
                  onClick={handleStartTrial}
                  className="w-full sm:w-1/2 py-3.5 rounded-xl border border-slate-300 hover:bg-slate-50 text-slate-800 font-bold text-xs flex items-center justify-center gap-2 cursor-pointer transition-all shadow-xs"
                >
