          ...
          return (
            <div key={v.id} className="flex items-center shrink-0">
              ...
              <button
                ...
                className="px-1.5 py-1 rounded-r-md bg-[#141720] hover:bg-red-500/20 text-[var(--text-muted)] hover:text-red-400 border-y border-r border-[#222736] transition-colors"
                title="Delete view"
              >
                <X className="w-3 h-3" />
              </button>
