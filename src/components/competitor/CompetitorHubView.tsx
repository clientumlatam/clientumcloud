...
- WhatsApp sin cobro punitivo por mensaje y con soporte en español local.`;
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-50 dark:bg-[#0b1329] text-slate-900 dark:text-slate-100 overflow-y-auto">
      {/* Header Banner */}
      <div className="border-b border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#0f172a] px-6 py-5 shrink-0 shadow-xs">
        ...
        {/* Sub-Navigation Tabs */}
        <div className="max-w-7xl mx-auto flex items-center gap-2 mt-6 border-b border-slate-200 dark:border-slate-800 -mb-5">
          <button
        ...
        {activeSubTab === 'migration' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs">
            ...
            {/* Preview Table */}
            <div className="bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 rounded-xl shadow-xs overflow-hidden">
              <div className="p-4 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 bg-slate-50/50 dark:bg-slate-900/30">
                <div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs text-slate-600 dark:text-slate-300">
                  <thead className="bg-slate-100 dark:bg-slate-800/60 text-slate-500 dark:text-slate-400 uppercase text-[10px] font-bold tracking-wider">
                    <tr>
                  ...
                  <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                    {migrationData.map((row) => (
                      <tr key={row.sourceId} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
        ...
        {activeSubTab === 'calculator' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-1 bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-xs space-y-5">
                ...
                <div>
                  <div className="flex justify-between items-center text-xs mb-1.5">
                    <span className="font-semibold text-slate-700 dark:text-slate-300">Vendedores / Asientos:</span>
                ...
                <div>
                  <div className="flex justify-between items-center text-xs mb-1.5">
                    <span className="font-semibold text-slate-700 dark:text-slate-300">Base de Contactos:</span>
              ...
              <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* HubSpot Card */}
                <div className="bg-white dark:bg-[#0f172a] border border-orange-200 dark:border-orange-950/60 rounded-xl p-5 shadow-xs flex flex-col justify-between">
                  <div>
                  ...
                  <div className="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 text-[11px] text-rose-600 dark:text-rose-400 font-bold">
                    Costo mensual: ~${Math.round(tcoMetrics.hsTotalYear / 12).toLocaleString()} USD/mes
                  </div>
                </div>

                {/* Salesforce Card */}
                <div className="bg-white dark:bg-[#0f172a] border border-sky-200 dark:border-sky-950/60 rounded-xl p-5 shadow-xs flex flex-col justify-between">
                  <div>
                    <div className="flex items-center justify-between">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-xs space-y-4">
              ...
              <div className="space-y-3 text-xs">
                <div className="p-3 bg-slate-50 dark:bg-slate-900/60 rounded-lg border border-slate-200/70 dark:border-slate-800">
          ...
          <div className="bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 rounded-xl shadow-xs overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                <thead className="bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 uppercase text-[10px] font-bold">
                  <tr>
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                  {[
                    ...
                    <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                      <td className="px-5 py-3 font-semibold text-slate-800 dark:text-slate-200">{row.feat}</td>
                      <td className="px-5 py-3 font-bold text-emerald-600 dark:text-emerald-400 bg-indigo-50/30 dark:bg-indigo-950/20">
                        {row.cl}
                      </td>
                      <td className="px-5 py-3 text-slate-500 dark:text-slate-400">{row.hs}</td>
                      <td className="px-5 py-3 text-slate-500 dark:text-slate-400">{row.sf}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
